...
const IconCopy = function({ width = 19, height = 22, fill = "white", ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      width={width}
